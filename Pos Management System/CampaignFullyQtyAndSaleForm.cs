...
{
    public partial class CampaignFullyQtyAndSaleForm : Form
    {
        public CampaignFullyQtyAndSaleForm()
        {
            InitializeComponent();
        }
        ...
        /// <summary>
        /// บันทึก แคมเปญ ซื้อครบจำนวน ได้รับสิทธิ์แลกซื้อ สินค้าต่างๆ
        /// </summary>
        ...
        private void SaveCommit()
        {
            using (SSLsEntities db = new SSLsEntities())
            {
                ...
                ps.FKCampaign = MyConstant.CampaignType.FullyQtyAndPrice;
                // dd/MM/yyyy
                ...
                ps.FullPrice = 0;
                ps.FullQty = decimal.Parse(textBoxProQty.Text);
                ps.Discount = 0;
                ps.IsStop = false;
