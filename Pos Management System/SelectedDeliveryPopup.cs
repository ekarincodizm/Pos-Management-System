...
{
    public partial class SelectedDeliveryPopup : Form
    {
        private List<DeliveryType> data;
        private SaleOrderWarehouseForm saleOrderWarehouseForm;

        public SelectedDeliveryPopup()
        {
            InitializeComponent();
        }

        public SelectedDeliveryPopup(SaleOrderWarehouseForm saleOrderWarehouseForm, List<DeliveryType> data)
        {
            InitializeComponent();
        ...
        private void SelectedDeliveryPopup_Load(object sender, EventArgs e)
        {
        ...
        void SendDataChoose(int id)
        {
            ...
            this.saleOrderWarehouseForm.BinddingDeliverSelected(data);
            this.Dispose();
        }
        /// <summary>
        /// เลือก
