...
namespace Pos_Management_System
{
    public partial class ProductGroupForm : Form
    {
        ...
        private void dataGridView1_SelectionChanged(object sender, EventArgs e)
        {
            ...
            //bool enable = Singleton.SingletonProductGroup.Instance().ProductGroups.SingleOrDefault(w => w.Id == id).Enable;
            //if (enable)
            //{
                radioButton1.Checked = true;
            //}
        ...
        public void dataGrid()
        {
            ...
            var data = Singleton.SingletonProductGroup.Instance().ProductGroups;
