...
{
    public partial class CampiagnFullyQtyAndDiscount : Form
    {
        public CampiagnFullyQtyAndDiscount()
        {
            InitializeComponent();
        }
        ...
        int colRemark = 5;
        int colId = 6;
        private void CampiagnFullyQtyAndDiscount_Load(object sender, EventArgs e)
        {
        ...
        private void SaveCommit()
        {
            ...
            using (SSLsEntities db = new SSLsEntities())
            {
                ...
                ps.FKCampaign = MyConstant.CampaignType.FullyQtyAndDiscount;
                // dd/MM/yyyy
