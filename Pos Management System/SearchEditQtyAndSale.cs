...
{
    public partial class SearchEditQtyAndSale : Form
    {
        private int id;

        public SearchEditQtyAndSale()
        {
            InitializeComponent();
        }

        public SearchEditQtyAndSale(int id)
        {
            InitializeComponent();
            this.id = id;
        }

        private void SearchEditQtyAndSale_Load(object sender, EventArgs e)
        {
            Reload();
        }
