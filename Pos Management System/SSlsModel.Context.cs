...
namespace Pos_Management_System
{
    ...
    public partial class SSLsEntities : DbContext
    {
        ...
        public virtual DbSet<MemberChangeMoney25601> MemberChangeMoney25601 { get; set; }
        public virtual DbSet<MemberChangeMoney2560Del> MemberChangeMoney2560Del { get; set; }
        public virtual DbSet<MemberShare> MemberShare { get; set; }
        public virtual DbSet<Sex> Sex { get; set; }
        public virtual DbSet<Share> Share { get; set; }
        public virtual DbSet<ShareMonth> ShareMonth { get; set; }
        ...
        public virtual DbSet<CheckPromotionDiscountView> CheckPromotionDiscountView { get; set; }
        public virtual DbSet<SellingPriceActive> SellingPriceActive { get; set; }
        public virtual DbSet<V_AllWasteMinus> V_AllWasteMinus { get; set; }
        public virtual DbSet<V_AllWastePlus> V_AllWastePlus { get; set; }
        public virtual DbSet<V_CurrentWasteStock> V_CurrentWasteStock { get; set; }
        public virtual DbSet<V_DifStockCount01> V_DifStockCount01 { get; set; }
        public virtual DbSet<V_DifStockCount02> V_DifStockCount02 { get; set; }
        public virtual DbSet<V_DifStockCount03> V_DifStockCount03 { get; set; }
        public virtual DbSet<V_LastWasteWarehouse> V_LastWasteWarehouse { get; set; }
        public virtual DbSet<V_PO> V_PO { get; set; }
        public virtual DbSet<V_Profit> V_Profit { get; set; }
        public virtual DbSet<V_RcvDetail> V_RcvDetail { get; set; }
        public virtual DbSet<V_Stkmas> V_Stkmas { get; set; }
        public virtual DbSet<V_StockBal01> V_StockBal01 { get; set; }
        public virtual DbSet<V_StockBal02> V_StockBal02 { get; set; }
        public virtual DbSet<V_StockCard> V_StockCard { get; set; }
        public virtual DbSet<V_StockCount01> V_StockCount01 { get; set; }
        public virtual DbSet<V_StockCount02> V_StockCount02 { get; set; }
        public virtual DbSet<V_StockDetail> V_StockDetail { get; set; }
        public virtual DbSet<V_WmsCard> V_WmsCard { get; set; }
        public virtual DbSet<View_CheckFront_01_11_17> View_CheckFront_01_11_17 { get; set; }
        public virtual DbSet<View_CheckFront_01_11_17_BCK> View_CheckFront_01_11_17_BCK { get; set; }
        public virtual DbSet<View_GetFrontStockByProductDate> View_GetFrontStockByProductDate { get; set; }
        public virtual DbSet<View_สมาช_กรายช__อ> View_สมาช_กรายช__อ { get; set; }
    
        [DbFunction("SSLsEntities", "fn_GetResultDate")]
        public virtual IQueryable<fn_GetResultDate_Result5> fn_GetResultDate(string ddate, string prodF, string prodT)
        {
            var ddateParameter = ddate != null ?
                new ObjectParameter("Ddate", ddate) :
                new ObjectParameter("Ddate", typeof(string));
    
            var prodFParameter = prodF != null ?
                new ObjectParameter("ProdF", prodF) :
                new ObjectParameter("ProdF", typeof(string));
    
            var prodTParameter = prodT != null ?
                new ObjectParameter("ProdT", prodT) :
                new ObjectParameter("ProdT", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_GetResultDate_Result5>("[SSLsEntities].[fn_GetResultDate](@Ddate, @ProdF, @ProdT)", ddateParameter, prodFParameter, prodTParameter);
        }
