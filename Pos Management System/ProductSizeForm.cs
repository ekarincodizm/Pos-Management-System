...
{
    public partial class ProductSizeForm : Form
    {
        public ProductSizeForm()
        {
            InitializeComponent();
        }
        ...
        private void ProductSizeForm_Load(object sender, EventArgs e)
        {
            ...
            var data = Singleton.SingletonPriority1.Instance().ProductSize;
        ...
        private void dataGridView1_SelectionChanged(object sender, EventArgs e)
        {
            ...
            bool enable = Singleton.SingletonPriority1.Instance().ProductSize.SingleOrDefault(w => w.Id == id).Enable;
            if (enable)
            {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            using (SSLsEntities db = new SSLsEntities())
            {
                if (_Id == 0)
                {
                    ...
                    db.ProductSize.Add(obj);
                }
                else
                {
                    // edit
                    var obj = db.ProductSize.SingleOrDefault(w => w.Id == _Id);
                    obj.UpdateDate = DateTime.Now;
                    obj.UpdateBy = Singleton.SingletonAuthen.Instance().Id;
                    obj.Code = textBoxCode.Text;
                    obj.Name = textBoxName.Text;
